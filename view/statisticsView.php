  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="?c=statistics" class="list-group-item list-group-item-action list-group-item-secondary">Estadísticas</a>
      ...
      <div class="container-fluid">
        <div class="card-body">
          <div class="card-title align-items-center row" style="font-size:25px">
            <h1 class="display-4 col-auto mr-auto">Estadísticas</h1>
