  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="?c=config" class="list-group-item list-group-item-action list-group-item-secondary">Configuración del Sistema</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
      ...
      <div class="container-fluid">
        <div class="card-body">
          <div class="card-title align-items-center row" style="font-size:25px">
            <h1 class="display-4 col-auto mr-auto">Configuración</h1>
